function Isosurfaces( volume, isovalue,c_value )
{
    ...
    material.color = new THREE.Color().setHex( cmap[c_value][1] );
    ...
    {
        var x0=0,y0=0,z0=0;
	var s0=volume.values[v0.x+v0.y*volume.resolution.x+v0.z*volume.resolution.y*volume.resolution.x];
	var s1=volume.values[v1.x+v1.y*volume.resolution.x+v1.z*volume.resolution.y*volume.resolution.x];
	x0=(s-s0)/(s1-s0)*(v1.x-v0.x)+v0.x;
	y0=(s-s0)/(s1-s0)*(v1.y-v0.y)+v0.y;
	z0=(s-s0)/(s1-s0)*(v1.z-v0.z)+v0.z;
